...
export const RecipeCard: React.FC<RecipeCardProps> = ({ recipe, index }) => (
  <Link to={`/recipe/${recipe.id}`}>
    <motion.div
      ...
      className="group relative flex flex-col bg-white dark:bg-zinc-900 rounded-3xl overflow-hidden border border-slate-100 dark:border-zinc-800 hover:border-primary-500/30 dark:hover:border-primary-500/30 transition-all active:scale-[0.98]" // Changed flex to flex-col, removed h-32
    >
